...
version = geocamCommon.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamCommon.get_version()
...
htmlhelp_basename = 'geocamCommonWebdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamCommonWeb Documentation',
